...
try:
    test_size = st.sidebar.slider("Test Set Size (%)", 0, 100, 20, 5)
    ...
    # Display model performance based on user selection
    ...
    # Allow the user to make predictions on new data
    ...
    try:
        ...
        #st.image(image, caption=f"Predicted {iris.target_names[prediction]}", use_column_width=False, width=200, clamp=True)
    ...
    # Display the dataset based on user selection
